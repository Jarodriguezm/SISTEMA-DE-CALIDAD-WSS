...
function RutaPrivada({ children }) {
  ...
  if (cargando) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, background: 'var(--fondo)' }}>
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/admin/usuarios" element={<RutaPrivada><Usuarios /></RutaPrivada>} />
